    ...
    $(window).on("scroll load", function() {
        if ($(document).scrollTop() >= 20) {
            if ($(".site-header.header_trans-fixed").length) {
                $(".site-header.header_trans-fixed").not(".fixed-trans").addClass("pix-header-fixed");
                $(".fixed-trans").addClass("pix-header-fixed");
                $(".sticky-logo, .header-button-scroll").show(0);
                $(".header-button-default").hide(0)
            }
            ...
            if ($(".site-header.header_trans-fixed").length) {
                $(".site-header.header_trans-fixed").not(".fixed-trans").removeClass("pix-header-fixed");
                $(".fixed-trans").removeClass("pix-header-fixed");
                $(".sticky-logo, .header-button-scroll").hide(0);
                $(".main-logo, .header-button-default").show(0)
            }
            if ($(".right-menu.modern").length) {
